...
1.  Preparación de red para habilitar vMotion

2.  Revisión de condiciones para vMotion

3.  Migración de VMs entre host ESXi
...
En el paso **IPv4 Settings** (1), Click en **Use static IPv4 settings**
