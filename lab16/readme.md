...
(2), dar click en la pestaña **Configure** (3). En la sección de
**Networking**, seleccionar **Virtual switches** y dar click en **ADD
NETWORKING** (5).
...
En el paso **Select target device** (1), dar click en **New standard
switch** (2). Next (3).
...
**vMotion** (2), dar click en el servicio **vMotion** (3). Next
(4).
...
Seleccionar el host **ESXi_02** (2), dar click en pestaña **Configure** (3)
en la sección de **Networking**, seleccionar **Virtual Switches** (4) y dar
...
En el paso **Port properties** (1), establecer como nombre del puerto
**vMotion** (2), dar click en el servicio **vMotion** (3). Next (4).
...
En el paso **IPv4 Settings** (1), dar click en **Use static IPv4 settings**
(2) y establecer la dirección ip `172.20.12.52` (3) con máscara de red
`255.255.255.0` (4). Next (5).
...
(2), dar click en la **VM Linux_02**, en el menú contextual encender la VM
con **Power ON** (5).
...
Revisar la red. Abrir el menú de redes (2) y dar click en **Browse** (3).
...
En el desktop dar click en **APs** (1).
