...
**DataStores VMFS su administración**
...
1.  Creación de DataStore VMFS con uso parcial de la capacidad de una
    LUN

2.  Creación de DataStore VMFS con uso total de una LUN

3.  Expansión de un DataStore VMFS con reclamo de capacidad sin consumir
    de una LUN

4.  Eliminación de un DataStore VMFS
...
necesario dar click en la vista de almacenamiento (1), click en el
...
Proceder con la creación de un segundo datastore, Click en vista de
...
Seleccionar tipo **VMFS** (2), Click **Next** (3)
...
Revisar configuración final **Finish** (3)
...
en la **LUN**, Click en la vista de almacenamiento (1), click en el
