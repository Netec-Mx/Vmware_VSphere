...
principal** (1) y seleccionar **Content Libraries** (2). Dar click en **New**
(3).
...
Establecer el nombre de la librería: **SA-Local-Content-Library** y
seleccionar el vcenter **sa-vcsa-01-vclass**. Next (4).
...
Revisar la configuración y aceptarla. FINISH (3).
...
contextual y dar click en **Clone to library (4)**.
...
Determinar que es una nueva plantilla (1). Seleccionar la librería
...
Para ver la nueva plantilla dar click en la librería (1).
