...
Click en **VMkernel** Network Adapter (2). Next (3).
...
Seleccionar: **Select an existing standard switch** (2). Dar click en
**vSwitch0** (3). Next (4).
...
Revisar la configuración del elemento de red. Finish (1).
...
en la sección de **Networking**, dar click en **Virtual switches** (3).
Expandir el **vSwitch0** (4) y dar click en **ADD NETWORKING** (5).
...
Dar click en **VMkernel Network Adapter** (2). Next (3).
...
red **255.255.255.0** en la dirección IP del puerto **VMkernel** (3). Next (4).
...
el **host** (1). Dar click en la pestaña **Configure** (2) en la sección de
...
Verificar el status **ENABLE** (5) y el **iSCSI Name** (6). Dar click en el **host**, click en pestaña **Configure** (2). Dar click en
**Storage adapter** y click en la tarjeta controladora **iSCSI** basada
en Software (4). Dar click en la pestaña **Properties** (5).
...
Determinar **Dynamic Discovery** (5). Dar click en **ADD** (6).
...
Realizar la asociación de puerto de red, dar click en **Network Port Binding**
(2). Dar click **ADD** (3).
...
Configuremos una controladora **iSCSI** en el host **ESXi-02**. Dar click en
el **host** (1) y en la pestaña **Configure** (2). En la sección de
**Storage**, dar click en **Storage Adapters** (3). Dar click en **ADD SOFTWARE
ADAPTER** (4) y en **Add iSCSI Adapter** (5).
...
Realizar asociación de puerto de red, dar click en **Network Port Binding**
(2). ADD (3).
...
Dar click en el puerto **VMkernel IP Storage** (1). OK (2).
...
Examinar las capacidades de cada **LUN** (3), dar click en **Devices** (2).
