...
**Almacenamiento, tecnología iSCSI**
...
1.  Agregar puerto **VMkernel** para el Storage en Host **ESXI_01**

2.  Agregar puerto **VMkernel** para el Storage en Host **ESXI_02**

3.  Agregar controladora **iSCSI** basada en software en **Host
    ESXI_01**

4.  Descubrir las **LUNs** desde el **Host ESXI_01**

5.  Agregar controladora **iSCSI** basada en software en Host
    **ESXI_02**

6.  Descubrir las **LUNs** desde el **Host ESXI_02**
...
Iniciemos con el Host **ESXi_01** y realizaremos una configuración
similar en el Host **ESXI-02**

Seleccionar el host **ESXi_01** (1), Click en pestaña **Configure** (2),
...
Establecer dirección estática (2) con IP **172.20.10.61** y máscara de
...
Seleccionar el host **ESXi_02** (1), Click en pestaña **Configure** (2),
en la sección de **Networking** click en **Virtual switches** (3),
expandir el **vSwitch0** (4), Click en **ADD NETWORKING** (5)
...
Establecer dirección estática (2) con IP **172.20.10.62** y máscara de
red **255.255.255.0** en la dirección ip del puerto **VMkernel** (3),
click **NEXT** (4)
...
Configuremos una controladora **iSCSI** en el host **ESXi-01**, click en
