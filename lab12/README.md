...
**Incremento de recursos en las VMs**
...
1.  Incremento de memoria virtual y capacidad de un disco

2.  Cambio de nombre de una VM

## Actividad \# 1

**Incremento de memoria virtual y capacidad de un disco**
...
Ejecutemos la aplicación **DISK** (3) del sistema operativo
