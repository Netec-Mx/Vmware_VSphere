...
**Integración de Hosts al inventario y configuración del protocolo NTP
en un host con vCenter Server**
...
Activar el modo **lockdown mode** para proteger el acceso al **hos**t
...
Para eliminarlas click en las ligas de **Actions** y click sobre:
**Suppress Warning**
...
Para configurar NTP en el **host ESXi-02**, seleccionarlo (1), click en
...
Click en: **Host ESXi_02**, (1) Click en pestaña **Configure** (2),, en
